...
plot(main_data$Voltage, type='l',ylab="Voltage",xlab="datetime",xaxt='n')
axis(1, at=c(1, thu,thu+fri), labels=c("Thu", "Fri","Sat"))
...
axis(1, at=c(1, thu,thu+fri), labels=c("Thu", "Fri","Sat"))
plot(main_data$Global_reactive_power, type='l',ylab="Global_reactive_power",xlab="datetime",xaxt='n')
axis(1, at=c(1, thu,thu+fri), labels=c("Thu", "Fri","Sat"))
dev.off()
